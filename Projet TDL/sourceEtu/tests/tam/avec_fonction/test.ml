...
(*Variable locale*)
let%expect_test "test_sujetlocal" =
  runtam (pathFichiersRat^"test_sujetlocal.rat");
  [%expect{| 1234 |}]


  let%expect_test "test_complexelocal" =
  runtam (pathFichiersRat^"test_complexelocal.rat");
  [%expect{| 1223 |}]


  let%expect_test "test_complique" =
  runtam (pathFichiersRat^"test_complique.rat");
  [%expect{| 122233 |}]

(*Variable globale*)
let%expect_test "test_sujet.rat" = 
  runtam (pathFichiersRat^"test_sujet.rat");
  [%expect{| 13574|}]

  let%expect_test "test_2v.rat" = 
  runtam (pathFichiersRat^"test_2v.rat");
  [%expect{| 11334433|}]
(*Tests TP*)
