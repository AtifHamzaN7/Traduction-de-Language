...
(*Variable globale*)
let%test "test_sujet.rat" = 
  test (pathFichiersRat^"test_sujet.rat") "main" ("x",1) (0 , "SB")
  && test (pathFichiersRat^"test_sujet.rat") "main" ("a",1) (1 , "SB")
  && test (pathFichiersRat^"test_sujet.rat") "inc" ("y",1) (-1 , "LB")

 


  let%test "test_2v.rat" = 
  test (pathFichiersRat^"test_2v.rat") "main" ("x",1) (0 , "SB")
  && test (pathFichiersRat^"test_2v.rat") "main" ("y",1) (1 , "SB") 
  && test (pathFichiersRat^"test_2v.rat") "main" ("a",1) (2 , "SB")
  && test (pathFichiersRat^"test_2v.rat") "inc_x" ("z",1) (-1 , "LB")
  && test (pathFichiersRat^"test_2v.rat") "inc_y" ("z",1) (-1 , "LB")
