...
(**********)
(*Type par defaut*)
let%test_unit "test_defaut.rat" = 
  let _ = compiler (pathFichiersRat^"test_defaut.rat") in ()

(*Variable locale*)
let%test_unit "test_sujetlocal.rat" = 
  let _ = compiler (pathFichiersRat^"test_sujetlocal.rat") in ()

  let%test_unit "test_complexelocal.rat" = 
  let _ = compiler (pathFichiersRat^"test_complexelocal.rat") in ()

(*Variable globale*)
let%test_unit "test_sujet.rat" = 
  let _ = compiler (pathFichiersRat^"test_sujet.rat") in ()

  let%test_unit "test_2v.rat" = 
  let _ = compiler (pathFichiersRat^"test_2v.rat") in ()
(*Tests TP*)
